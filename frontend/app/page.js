  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white p-4 relative">
      ...
      <div className="absolute top-4 right-4 flex gap-3">
        <Link
          href="/status"
          className="px-3 py-1 bg-emerald-500 rounded hover:bg-emerald-600 transition-colors text-sm font-medium"
        >
          Status
        </Link>
        <Link
          href="/about"
          className="px-3 py-1 bg-blue-500 rounded hover:bg-blue-600 transition-colors text-sm font-medium"
        >
          About
        </Link>
      </div>
